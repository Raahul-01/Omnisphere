...
import { Award, Calendar, Clock, Trophy, Star, TrendingUp, Sparkles, Crown } from "lucide-react"
...
export function BestOfWeekFeed({ articles }: BestOfWeekFeedProps) {
  ...
  return (
    <div className="container relative mx-auto px-4 pt-16 md:pt-20 pb-6 ml-0 md:ml-[240px] max-w-full md:max-w-[calc(100vw-240px)]">
